...
<html lang="{{app('l')}}" dir="{{app('dir')}}">
    ...
    <head>
        ...
        <meta content="XArea Website" name="description" />
        <meta content="Abdulrhman" name="author" />
        ...
        <link href="{{ url("design/admin_panel/assets/global/css/style.css") }}" rel="stylesheet" type="text/css" />
        @if(app("l") != 'ar')
